...
public class DerbyDAO {
    ...
    /**
     * Returns the total number of users. Useful for dashboard summary card.
     */
    ...
    public boolean addUser(String username, String password, String role) {
        if (!isValidInput(username, password, role)) return false;
    ...
    public boolean bulkDeleteUsers(String[] usernames) {
        if (usernames == null || usernames.length == 0) return false;
